...
<div class="container mt-4 mb-4">
  <div class="card">
    ...
    <div class="card-body">
      ...
      <form action="index.php" method="GET" onsubmit="return addOrder();">
        <div class="row align-items-start">
          <div class="col">
            <div class="mb-3">
              ...
              <div id="error_name">
                <div class="text-danger small">
                  <p><?php if (isset($error_name)) echo $error_name ?></p>
                </div>
              </div>
            </div>
            ...
            <div class="mb-3">
              ...
              <div id="error_phone_number" class="text-danger">
                <p><?php if (isset($error_phone_number)) echo $error_phone_number ?></p>
              </div>
            </div>
            ...
            <div class="mb-3">
              ...
              <div id="error_address">
                <div class="text-danger small">
                  <p><?php if (isset($error_address)) echo $error_address ?></p>
                </div>
              </div>
          ...
          <div class="col">
            <div class="mb-3">
              ...
              <div id="error_brand">
                <div class="text-danger small"><?php if (isset($error_brand)) echo $error_brand ?></div>
              </div>
            </div>
            ...
            <div class="mb-3">
              ...
              <div id="error_model">
                <div class="text-danger small"><?php if (isset($error_model)) echo $error_model ?></div>
              </div>
            </div>
            ...
            <div class="mb-3">
              ...
              <div id="error_color">
              <div class="text-danger small"><?php if (isset($error_color)) echo $error_color ?></div>
              </div>
            </div>
          </div>
        </div>

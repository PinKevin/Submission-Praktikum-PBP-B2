        ...
        <div class="row align-items-start">
          <div class="col">
            <div class="mb-3">
              ...
              <div id="error_name" class="text-success"><?php if (isset($error_name)) echo $error_name ?>
              </div>
            </div>
            ...
            <div class="mb-3">
              ...
              <div id="error_phone_number" class="text-success"><?php if (isset($error_phone_number)) echo $error_phone_number ?>
              </div>
            </div>
            ...
            <div class="mb-3">
              ...
              <div id="error_address"><?php if (isset($error_address)) echo $error_address ?>
              </div>
            </div>
          ...
          <div class="col">
            ...
            <div class="mb-3">
              ...
              <div id="error_model"><?php if (isset($error_model)) echo $error_model ?>
              </div>
            </div>
            ...
            <div class="mb-3">
              ...
              <div id="error_color"><?php if (isset($error_color)) echo $error_color ?>
              </div>
            </div>
          </div>
        </div>

      ...
      <div class="card-body">
        <form method="POST" autocomplete="on" action="">
          ...
          <div class="form-group mt-3">
            ...
            <select id="kelas" name="kelas" class="form-control" onchange="toggleEkstrakurikuler(this.value)">
          ...
          <div id="ekstrakurikuler-group" style="display: none;">
            ...
            <div class="form-check">
              ...
              <div class="form-check">
                <input type="checkbox" class="form-check-input" name="ekstrakurikuler[]" value="Sinematografi" <?php if (isset($_POST['ekstrakurikuler']) && in_array('Sinematografi', $_POST['ekstrakurikuler']))
                echo 'checked' ?>>

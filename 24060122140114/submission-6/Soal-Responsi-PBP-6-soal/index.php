                    ...
                    <div class="col">
                        ...
                        <div class="mb-3">
                            ...
                            <div class="row align-items-start g-0">
                                ...
                                <div class="col">
                                    <div class="form-check">
                                        <input class="form-check-input" type="radio" name="color" id="Gray"
                                            value="Gray">
                                        <label class="form-check-label" for="black">
                                            Gray
                                        </label>
                                    ...
                                    <div class="form-check">
                                        <input class="form-check-input" type="radio" name="color" id="Silver"
                                            value="Silver">
                                        <label class="form-check-label" for="white">
                                            Silver
                                        </label>
                                ...
                                <div class="col">
                                    <div class="form-check">
                                        <input class="form-check-input" type="radio" name="color" id="Navy_Blue"
                                            value="Navy_Blue">
                                        <label class="form-check-label" for="black">
                                            Navy Blue
                                        </label>
                                    ...
                                    <div class="form-check">
                                        <input class="form-check-input" type="radio" name="color" id="Military_Green"
                                            value="Military_Green">
                                        <label class="form-check-label" for="white">
                                            Military Green
                                        </label>
                                    </div>
